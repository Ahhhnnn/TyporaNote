...
在page页面的同级目录下创建一个not-found页面，用于默认的404页面
...
![image-20240907003021079](assets/image-20240907003021079.png)
...
为您的应用程序生成一个密钥。该密钥用于加密cookie，确保用户会话的安全。您可以通过在终端中运行以下命令来完成此操作：
...
```
+ia7yIzyb2hhFKPj08m4N8Z+ELegTQNhqCiN9fTxg3A=
```
